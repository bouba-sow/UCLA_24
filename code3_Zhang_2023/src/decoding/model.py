"""Two-layer LSTM decoder (Zhang et al. 2023, Fig. 2a, Supp. Table 5)."""
from __future__ import annotations

import torch
import torch.nn as nn

from zhang2023_constants import WEIGHT_INIT_GAUSS_STD, WEIGHT_INIT_UNIFORM


class CharacterLSTM(nn.Module):
    """2×128 LSTM → FC → LeakyReLU → BatchNorm → FC → (n_chars, 3) logits."""
